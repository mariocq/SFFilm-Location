...
class CloudModule extends Component {
  constructor(props) {
        super(props);

        // Cloud javascript, initialize and render
        $(document).ready(function(){
            ...
            $(window).resize(function() {
              $("#move-top").css({
        		...
        		document.getElementById("cloudBody").style.background = 'url(' + canvas.toDataURL('image/png') + ')';
              ...
              container.style.height = bgHeight + "px";
        			...
        			document.getElementById("cloudBody").appendChild( container );
        			...
        			renderer.setSize( $('body').width(), bgHeight );
